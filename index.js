...
/////////////////
const BotName = 'Bayu Bot☄'; 
const instagram = 'https://instagram.com/pangeran_berdasi_0'; 
const telegram = 'https://t.me/bayuu'; 
const kapanbotaktif = 'AKTIF KETIKA JAM 7'; 
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@Pangeran_berdasi_0`)
})
